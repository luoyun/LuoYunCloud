...
DATABASES = {
    'default': {
        ...
        'NAME': 'lyweb',                      # Or path to database file if using sqlite3.
        'USER': 'luoyun',                      # Not used with sqlite3.
        'PASSWORD': 'luoyun',                  # Not used with sqlite3.
