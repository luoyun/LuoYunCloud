...
def procOSMQuery(sock, datalen, data):
  ...
  if datalen != l or len(data) != l:
    ...
    return 1
  lyutil.socksend(sock, lydef.PKT_TYPE_CLC_OSM_QUERY_REPLY,
...
def process(sock, packet):
  ...
  if type == lydef.PKT_TYPE_TEST_ECHO_REQUEST:
    sock.socksend(sock, lydef.PKT_TYPE_TEST_ECHO_REPLY, packet[h:])
  elif type == lydef.PKT_TYPE_CLC_OSM_QUERY_REQUEST:
